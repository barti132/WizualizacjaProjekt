"""
Skrypt ściągający dane z lp3-data i z spotify, zapisuje dane w lp3-data-data#.csv
...
#with open('lp3-data-data.csv', 'w', newline='') as file:
#    writer = csv.writer(file)
#    writer.writerow(["week timestamp", "track name", "artist name", "last position", "weeks on list", "rank", "genres"])

with open('lp3-data-data14.csv', 'w', newline='', encoding="utf-8") as file:
    writer = csv.writer(file)
